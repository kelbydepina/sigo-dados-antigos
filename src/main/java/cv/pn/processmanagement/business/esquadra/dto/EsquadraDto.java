package cv.pn.processmanagement.business.esquadra.dto;
...
public class EsquadraDto {
    ...
    private String idSigComarca;
    private String idUnidadeSig;
    ...
    public String getIdSigComarca() {
        return idSigComarca;
    }

    public void setIdSigComarca(String idSigComarca) {
        this.idSigComarca = idSigComarca;
    }

    public String getIdUnidadeSig() {
        return idUnidadeSig;
    }

    public void setIdUnidadeSig(String idUnidadeSig) {
